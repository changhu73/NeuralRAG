...
if __name__ == "__main__":
    file_name = "C:/Users/13772/OneDrive/文档/GitHub/NeuralRAG/bio/Gasperini/mmc4.xlsx"
    sheet_index = 3

    ENSG_index = 8
    enhancer_start_index = 2
    enhancer_end_index = 3

    # # enhancer start/end form excel
    ENSG_data = get_column_data(file_name, sheet_index, ENSG_index)
    enhancer_start_data = get_column_data(file_name, sheet_index, enhancer_start_index)
    enhancer_end_data = get_column_data(file_name, sheet_index, enhancer_end_index)
    ...
    output_folder = 'dataset/output_files_mmc4'
