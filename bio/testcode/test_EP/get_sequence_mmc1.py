...
if __name__ == "__main__":
    file_name = "C:/Users/13772/OneDrive/文档/GitHub/NeuralRAG/bio/Gasperini/mmc1.xlsx"
    sheet_index = 2

    ENSG_index = 1
    enhancer_start_index = 6
    enhancer_end_index = 7
    ...
    output_folder = 'dataset/output_files_mmc1'
